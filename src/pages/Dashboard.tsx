...
const Dashboard: React.FC = () => {
    ...
    const mappedCount = data.entities.filter((e: any) => e.latitude && e.longitude).length;
    const partnershipCount = data.relationships.filter((r: any) => r.relationship_type === 'partnership').length;
